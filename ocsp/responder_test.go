...
import (
	...
	goocsp "github.com/hxx258456/ccgo/xcrypto/ocsp"
...
func TestCacheHeaders(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Etag", "\"998AC0A72DD4E3D8DDD0AF671523AB1C027F6F338A3CD2BDB7C480EFE67166FC\""},
	}
	...
	rw = httptest.NewRecorder()
	headers := http.Header{}
	headers.Add("If-None-Match", "\"998AC0A72DD4E3D8DDD0AF671523AB1C027F6F338A3CD2BDB7C480EFE67166FC\"")
	responder.ServeHTTP(rw, &http.Request{
		Method: "GET",
		URL: &url.URL{
			Path: "MEMwQTA/MD0wOzAJBgUrDgMCGgUABBSwLsMRhyg1dJUwnXWk++D57lvgagQU6aQ/7p6l5vLV13lgPJOmLiSOl6oCAhJN",
